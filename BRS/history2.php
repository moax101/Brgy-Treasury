                ...
                <div class="col-8">
                                        ...
                                        $conn = mysqli_connect("localhost", "root", "", "store");
                                            if($conn ->connect_error){
                                                ...
                                                while ($row = mysqli_fetch_array($sth)) {   
                                                    echo "<tr><td>". $row["surname"]. "</td><td>". $row["status"]. "</td><td>". $row["brgy"]. "</td><td>" . $row["transaction2"]."</td><td>". $row["payment2"]."</td><td>". $row["exec_time"]. "</td><td>". $row["pending2"]. "</td><td> <form method='POST' action='#'>
                            ...
                            <?php
                                    if(isset($_POST["update"])){
                                        ...
                                        $sth = $db->query($sql);
                                        while ($row = mysqli_fetch_array($sth)) { 
                                        if($row['pending2']=="Pending") {                                          
                                            $insert = $db->query("UPDATE payment2 SET pending2='Already Taken' ");
                                            if($insert){
                                        ...
                                        {                                          
                                            $insert = $db->query("UPDATE payment2 SET pending2='Pending' ");
                                            if($insert){
                                                header("location:history2.php");
